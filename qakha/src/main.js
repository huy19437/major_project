...
library.add(faCaretLeft, faCaretRight, faCoffee, faAnchor, faGoogle, faFacebook, faArrowUp, faShoppingCart, faEdit, faTrashAlt, faUndo, faClipboardList, faCamera, faStore)
Vue.use(Vuelidate)
