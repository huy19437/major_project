...
import { faEnvelope, faPhoneAlt, faCaretLeft, faCaretRight, faCoffee, faAnchor, faArrowUp, faShoppingCart, faEdit, faTrashAlt, faUndo, faClipboardList, faCamera, faStore, faList, faCartPlus, faCoins, faMapMarkerAlt, faClock } from '@fortawesome/free-solid-svg-icons'
...
library.add(faEnvelope, faPhoneAlt, faCaretLeft, faCaretRight, faCoffee, faAnchor, faGoogle, faFacebook, faArrowUp, faShoppingCart, faEdit, faTrashAlt, faUndo, faClipboardList, faCamera, faStore, faList, faCartPlus, faCoins, faMapMarkerAlt, faClock)
Vue.use(Vuelidate)
